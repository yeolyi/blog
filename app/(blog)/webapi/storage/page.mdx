...
let getRawData = () =>
  Promise.resolve([
    { zipcode: '99553', city: 'Akutan', state: 'AK' },
    { zipcode: '99571', city: 'Cold Bay', state: 'AK' },
    { zipcode: '99583', city: 'False Pass', state: 'AK' },
    { zipcode: '99612', city: 'King Cove', state: 'AK' },
    { zipcode: '99661', city: 'Sand Point', state: 'AK' },
  ]);
...
function withDB(callback) {
  ...
  request.onupgradeneeded = (e) => initdb(e, callback);
}

// DB 초기 설정 후 데이터를 채웁니다.
function initdb(event, callback) {
...
lookupCity('99583', console.log);
lookupZipcodes('Akutan', console.log);
```
