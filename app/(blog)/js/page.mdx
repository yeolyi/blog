...
간략하게, **표현식**은 어떤 값으로 계산되지만 프로그램의 상태를 바꾸지는 않고,
**문**은 값은 없지만 상태를 바꿉니다.
...
NaN은 모든 값과 비교 결과가 false입니다. Number.isNaN 이나 isNaN을 씁시다. 두
함수의 차이점: https://stackoverflow.com/questions/33164725
...
바뀌어야한다면 let으로 수정하는 사람들이 있습니다.
https://overreacted.io/on-let-vs-const/ 참고할만한 아티클입니다.
