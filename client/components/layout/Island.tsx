...
export default function Island() {
  ...
  return (
    ...
    >
      <div
        className={`overflow-y-scroll overscroll-contain bg-white shadow-xl shadow-slate-700/10 ${expanded ? 'rounded-xl' : 'rounded-full'} no-scrollbar ring-1 ring-gray-900/5 dark:border dark:bg-black`}
      ...
      {!expanded && (
        <Link
          to="/"
          className="flex w-[40px] items-center justify-center rounded-full bg-white shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5 dark:border dark:bg-black"
        >
