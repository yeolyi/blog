...
GET /cs 200 in 1400ms
 │ GET https://api.resend.com/audiences/b8cb47fc-8bfe.. 200 in 1358ms (cache skip)
...
<blockquote><Suspense fallback={<span>-</span>}><SubscriberCount /></Suspense> subscribers and counting.</blockquote>
