export const title = 'Adding Multiplayer Cursors to the Blog';
...
I'm usually hesitant to post memes with this kind of slang on Instagram, but
here I can post freely 😉. In the next post, I'll share the tech stack I used
and the troubleshooting I encountered.
